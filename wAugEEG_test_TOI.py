    ...
    def augData(self):
        ...
        for n in tqdm(range(len(self.subIdx))):
            ...
            for k in range(self.kfold):
                ...
                # Weighted
                tmpPos, tmpNeg = [], []
                for label_type in ["test_positive", "test_negative"]:
                    ...
                    (tmpPos if label_type == "test_positive" else tmpNeg).extend(arr)
...
if __name__ == "__main__":
    ...
    for TOI in TOI_list:
        saveName = f"AugEEG_test_rw{TOI}_16.pkl"
